...
In the main project view on Netlify, select "<Emoji symbol='⚙️'/> Domain settings", then "Add custom domain". Enter the domain that you registered in step one and go through the flow.
