...
Hopefully that helps! Let me know if you have any suggestions for the package. [PRs are most welcome <Emoji symbol="😊" />](https://github.com/SeanMcP/eleventy-plugin-heroicons/pulls).
